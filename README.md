...
В данный момент изучена библиотека для написания ботов на си https://github.com/smartnode/telebot

С использованием данной библиотеки написана небольшая часть кода, которая отвечает за возвращение в чат фотографии города по введенному названию города
